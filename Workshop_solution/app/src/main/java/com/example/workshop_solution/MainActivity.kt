...
import com.example.workshop_solution.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(view)
        binding.btnOpenCamera.setOnClickListener() {startActivity(Intent(this,Camera::class.java))}
